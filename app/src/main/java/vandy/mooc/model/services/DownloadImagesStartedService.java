...
public class DownloadImagesStartedService 
    ...
    public static Intent makeIntent(Context context,
        ...
        RequestMessage requestMessage = RequestMessage.makeRequestMessage(requestCode, url, directoryPathname, messenger);
    ...
    public void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            URL url = new URL(requestMessage.getImageURL().toString());
            // Download the requested image.
            // TODO -- you fill in here.
            Uri imgPath = NetUtils.downloadImage(getApplicationContext(),
                                    requestMessage.getImageURL(),
                    ...
                    // TODO -- you fill in here.
                    sendPath(requestMessage.getMessenger(),
                            imgPath,
                            requestMessage.getImageURL(),
